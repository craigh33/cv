  ...
  \experience
    ...
    {Oct 2022} {
                      ...
                      \begin{itemize}
                        ...
                        \item Cloud Technology – Due to my involvement in the Cloud management solution, I was exposed to both AWS and Azure technologies and best practices. This has not only given me strong fundamentals in cloud architecture and best practices, but also helped me to develop my skills in Terraform and the different cloud products that each platform offers.
                        ...
                        \item Team Leadership – As a mid-level engineer, I have helped mentor and support more junior members of the team to help them grow their skills and impart my knowledge via documentation and pair programming.
                      \end{itemize}
                    }
                    {Go, AWS Bedrock, Genkit, MCP, A2A, promptfoo, KNative, Terraform, Kubernetes, Kustomize, Angular, DevExpress DevExtreme, GraphQL, Apollo, gRPC, REST, C#, Node.js, Jenkins, Azure, SAGA Patterns, DocumentDB, PostgreSQL, MySQL, Microservices}
  \emptySeparator
  \experience
    ...
    {Aug 2019}    {
                    ...
                    {C\#, WPF, MVVM, Prism, XUnit, NSubstitute, SQLite, Entity Framework Core, Universal Robots URScript, GitHub Actions, SonarQube, Artifactory JFrog, Azure Kubernetes Service, JIRA, ASP.NET SignalR, C++, Win32 API, SVN, GitHub}
  \emptySeparator
  \experience
    ...
    {June 2018}    {
                      ...
                      \begin{itemize}
                        \item Web Development Experience – I used a wide range of technologies relevant to the current market, including HTML, CSS, and JavaScript, and significantly increased my knowledge of PHP.
